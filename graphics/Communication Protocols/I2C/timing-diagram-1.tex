...
%         Frame   & Z 2D{Start}  \\
        ...
        \draw let \p1=($(stop-start)!0.5!(stop-end)$) in node[draw, fill=red!30, minimum height=1cm, text width=2cm, anchor=north, align=center] at (\x1, -5) (starttxt) {\textbf{Start Bit}\\Created by pulling SDA high, then SCL high};
        }
